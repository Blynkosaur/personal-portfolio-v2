  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-4xl mt-12 mx-auto text-left">
        ...
        asChild
        variant="outline"
             className="cursor-target absolute top-6 left-4 right-4 md:left-16 md:right-auto lg:left-24 z-10 bg-slate-800/30 text-slate-100 hover:bg-slate-700/50 hover:border-slate-300 hover:text-slate-600 transition-all duration-200 backdrop-blur-sm px-6 py-3 text-base"
